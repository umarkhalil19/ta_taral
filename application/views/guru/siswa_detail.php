                                ...
                                <div class="card-inner">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $siswa->nis; ?>">
                                                </div>
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="date" class="form-control" id="tgl_masuk" name="tgl_masuk" value="<?= set_value('tgl_masuk', $siswa->tgl_masuk) ?>">
                                                </div>
