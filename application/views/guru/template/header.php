                ...
                <div class="container-xl wide-xl">
                    <div class="nk-header-wrap">
                        ...
                        <div class="nk-header-brand">
                            <a href="<?= base_url('guru/index') ?>" class="logo-link">
                                ...
                                <img class="logo-dark logo-img" src="<?= base_url() ?>assets/images/logo-sekolah.png" srcset="<?= base_url() ?>assets/images/logo-sekolah.png 2x" alt="logo">
                            </a>
                        </div><!-- .nk-header-brand -->
                        <div class="nk-header-menu" data-content="headerNav">
                            ...
                            <ul class="nk-menu nk-menu-main ui-s2">
                                <li class="nk-menu-item">
                                    <a href="<?= base_url('guru/index') ?>" class="nk-menu-link">
                                        <span class="nk-menu-text">Dashboard</span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item">
                                    <a href="<?= base_url('guru/kelas') ?>" class="nk-menu-link">
