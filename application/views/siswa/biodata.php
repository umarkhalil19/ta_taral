                                ...
                                <div class="card-inner">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="nis" name="nis" value="Nomor Induk Siswa">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="Tempat Lahir">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" value="Pendidikan Terakhir">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="no_hp" name="no_hp" value="Nomor HP">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="ayah" name="ayah" value="Nama Ayah">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="ayah_kerja" name="ayah_kerja" value="Pekerjaan Ayah">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="ayah_no_hp" name="ayah_no_hp" value="Nomor HP Ayah">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="ibu" name="ibu" value="Nama Ibu">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="ibu_kerja" name="ibu_kerja" value="Pekerjaan Ibu">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="ibu_no_hp" name="ibu_no_hp" value="Nomor HP Ibu">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="wali" name="wali" value="Nama Wali">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="wali_kerja" name="wali_kerja" value="Pekerjaan Wali">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="wali_no_hp" name="wali_no_hp" value="Nomor HP Wali">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
